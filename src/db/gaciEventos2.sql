...
BEGIN
    ...
    DECLARE cliente CHAR(24);
	SET cliente = (	SELECT u.usuarioId 
					FROM audievento
					INNER JOIN usuario AS u ON u.usuarioId = audiEUsuario
					WHERE 	audiEEvento = eventoId AND
							(audiEAccion = "AVANZO" OR audiEAccion = "RETROCESO" OR audiEAccion = "REASIGNO")
					ORDER BY audiEFecha DESC
					LIMIT 1
				  );
	RETURN cliente;
END ;;
...
-- Dump completed on 2023-03-22 13:01:34
